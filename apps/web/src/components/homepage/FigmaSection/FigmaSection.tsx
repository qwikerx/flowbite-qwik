...
export const FigmaSection = component$(() => {
  return (
    <section class="bg-gray-50 dark:bg-gray-800">
      <div class="mx-auto max-w-8xl px-4 py-8 lg:py-24 xl:px-3">
        <div class="mx-auto grid max-w-8xl grid-cols-1 items-start justify-between gap-24 py-1 lg:grid-cols-2">
          <div class="flex flex-col gap-8">
            ...
            <div class="flex flex-col items-center gap-4">
              <p class="self-stretch">Check out the following resources to learn more about Flowbite Figma:</p>
              <div class="isolate flex flex-col items-start gap-4 self-stretch">
                <a
                  ...
                  class="inline-flex max-w-lg items-center justify-start gap-5 self-stretch rounded-lg border border-gray-300 bg-white px-4 py-3.5 text-center text-base font-medium text-gray-900 hover:bg-gray-100 focus:outline-hidden focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700 sm:gap-7"
                >
                ...
                <a
                  ...
                  class="inline-flex max-w-lg items-center justify-start gap-4 self-stretch rounded-lg border border-gray-300 bg-white px-4 py-3.5 text-center text-base font-medium text-gray-900 placeholder:py-3.5 hover:bg-gray-100 focus:outline-hidden focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700 sm:gap-6"
                >
                  <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    />
                    <defs>
                      <linearGradient id="paint0_linear_18_290714" x1="15.0448" y1="18.723" x2="17.4055" y2="10.5006" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#1724C9" />
                        <stop offset="1" stop-color="#1C64F2" />
                      </linearGradient>
                      <linearGradient id="paint1_linear_18_290714" x1="20.482" y1="8.69573" x2="14.2722" y2="2.50785" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#1C64F2" />
                        <stop offset="1" stop-color="#0092FF" />
                      </linearGradient>
                      <linearGradient id="paint2_linear_18_290714" x1="12.1232" y1="4.66137" x2="2.75555" y2="5.25331" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#0092FF" />
                        <stop offset="1" stop-color="#45B2FF" />
                      </linearGradient>
                      <linearGradient id="paint3_linear_18_290714" x1="11.49" y1="22.3927" x2="19.9027" y2="20.1226" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#1C64F2" />
                        <stop offset="1" stop-color="#0092FF" />
                      </linearGradient>
                      <linearGradient id="paint4_linear_18_290714" x1="5.45155" y1="12.6579" x2="11.4243" y2="18.8469" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#1724C9" />
                        <stop offset="1" stop-color="#1C64F2" />
                      </linearGradient>
                      <linearGradient id="paint5_linear_18_290714" x1="19.0877" y1="17.1224" x2="23.2551" y2="8.72159" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#0092FF" />
                        <stop offset="1" stop-color="#45B2FF" />
                      </linearGradient>
                      <linearGradient id="paint6_linear_18_290714" x1="4.0229" y1="7.74412" x2="1.7929" y2="16.1258" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#1C64F2" />
                        <stop offset="1" stop-color="#0092FF" />
                      </linearGradient>
                      <linearGradient id="paint7_linear_18_290714" x1="15.4074" y1="7.34521" x2="7.25835" y2="9.37416" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#1724C9" />
                        <stop offset="1" stop-color="#1C64F2" />
                      </linearGradient>
                      <linearGradient id="paint8_linear_18_290714" x1="4.80519" y1="16.9132" x2="9.99951" y2="24.7267" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#0092FF" />
                        <stop offset="1" stop-color="#45B2FF" />
                      </linearGradient>
                    </defs>
