  ...
  return (
    <section id="buttons">
      ...
      <div class="flex gap-2 items-center">
        ...
        {/*      <Button :loading="loading" color="default" loading-position="suffix" outline @click="loading = !loading">*/}
        {/*      Click me*/}
        {/*      <template #suffix>*/}
        ...
        {/*    </template>*/}
        {/*</Button>*/}
        {/*  <Button :loading="loading" gradient="green-blue" size="lg" @click="loading = !loading">*/}
        {/*    Click me*/}
        {/*  </Button>*/}
        {/*  <Button :loading="loading" gradient="pink" size="xl" @click="loading = !loading">*/}
        {/*    Click me*/}
        {/*  </Button>*/}
      </div>
