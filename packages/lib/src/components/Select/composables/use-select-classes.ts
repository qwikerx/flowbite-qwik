...
const underlineSelectClasses =
  'bg-transparent dark:bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:border-gray-700 focus:outline-hidden focus:ring-0 focus:border-gray-200 peer'
